<template>
    <li class="cart-item">
        <LazyImage class="thumbnail" :shouldLoad="true" :src="item.image.transformedSrc" alt="alt to fill" />
        ...
        <div class="section">
            <span class="counter">
                <button class="button" @click="decreaseItemQty(item)" @keyup="decreaseItemQty(item)">-</button>
                <label for="qty">
                    <input
                        :value="item.qty"
                ...
                <button class="button" @click="increaseItemQty(item)" @keyup="increaseItemQty(item)">+</button>
            </span>
        </div>
        ...
        <div class="hover-actions">
            <button class="remove" @click="removeItem(item.variantId)" @keyup="removeItem(item.variantId)">
