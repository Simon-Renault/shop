<template>
  <Layout>
    ...
    <CenteredContainer class="project-grid">
      ...
      <div class="centered">
        <h2>Gallery</h2>
        <p>Because the finished pieces are nothing without the proces the led to them, here is a gallery of various angles, moments and details taken during the process</p>
      </div>
