    ...
    <Layout>
        <CenteredContainer class="project-grid">
            ...
            <div class="centered">
                ...
                <p>
                    A curated collection of my best work, handpicked every month. If you don't know where to start, this
                    is the place to go.
                </p>
            </div>
            ...
            <div class="product-grid">
                ...
                >
                    <article>
                        <LazyImage
                            class="v-grid-item__img"
                            :shouldLoad="true"
                            ratio="100%"
                            :src="drawing.product.images[0].transformedSrc"
                            alt="alt"
                        />
                        <h3>{{ drawing.name }}</h3>
                        <p>
                            {{ drawing.product.priceRange.minVariantPrice.amount }}£ -
                            {{ drawing.product.priceRange.maxVariantPrice.amount }}£
                        </p>
                    </article>
                </g-link>
            </div>
            ...
            <div class="centered">
                <h2>Newsletter</h2>
                <p>
                    Subscribe and be informed of new publication, exhibitions, events and more! No spam, not more than
                    an email a month, that's a promisse.
                </p>
                <div class="input">
